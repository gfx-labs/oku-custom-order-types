...
async function main() {
  ...
  } else if (networkName == "zksolc") {
    LOR = limitOrderData.zkSyncEra.oracles[0].address
  }else if (networkName == "zksolc") {
    LOR = limitOrderData.zkSyncEra.oracles[0].address
    pools = [limitOrderData.zkSyncEra.oracles[0].tokens[0].address]//only 1 pool
  }else if (networkName == "scroll") {
    LOR = limitOrderData.scroll.oracles[0].address
    pools = limitOrderData.scroll.oracles[0].tokens[0].address
  }else if (networkName == "rootstock") {
    LOR = limitOrderData.rootstock.oracles[0].address
    pools = limitOrderData.rootstock.oracles[0].tokens[0].address
  }else if (networkName == "filecoin") {
    LOR = limitOrderData.filecoin.oracles[0].address
    pools = limitOrderData.filecoin.oracles[0].tokens[0].address
  }else if (networkName == "boba") {
    LOR = limitOrderData.bobaEthereum.oracles[0].address
    pools = [limitOrderData.bobaEthereum.oracles[0].tokens[0].address]//only 1 pool
  }else if (networkName == "moonbeam") {
    LOR = limitOrderData.moonbeam.oracles[0].address
    pools = [limitOrderData.moonbeam.oracles[0].tokens[0].address]//only 1 pool
  }else if (networkName == "polygonzkevm") {
    LOR = limitOrderData.polygonZkEVM.oracles[0].address
    pools = [limitOrderData.polygonZkEVM.oracles[0].tokens[0].address]//only 1 pool
  }else if (networkName == "mantapacific") {
    LOR = limitOrderData.mantaPacific.oracles[0].address
    pools = limitOrderData.mantaPacific.oracles[0].tokens[0].address
  ...
  console.log("Limit Order Registry: ", LOR)
  masterKeeper = await new MasterKeeper__factory(user).deploy(LOR)
  console.log("Deployed @: ", await masterKeeper.getAddress())

  if (mainnet && networkName != "mantapacific" && networkName != "boba" && networkName != "rootstock" && networkName != "filecoin") {
...
/**
 * Optimism 0x6D746d529F0D0C38A5abD561792917F8c4623E55 Verified
 * Arbitrum 0x560ac74DD8871c9d0d9d70Bdc4f79B82799777b0 Verified
 * Base 0xd829adF0FB755f38d1d691f822619C3fBaa5ccD0 Verified
 * BSC 0x54fE0D5dA2C787a93f2Dcb4d25E202C4e44e4458 Verified
 * Mainnet 0x15518AA548248d97479Ca3AE2358266f12B2A61A Verified
 * Polygon 0xAaD90A1e789357e98b540b034a7613Cfc06044e7 Verified
 * Filecoin 0x985A9a95558861ff5ef6CbEFEDfA9d8BfDbdabd1 verify failed 500 000000000000000000000000ded8791056aa39581460a005a3c400a281e24bd7
 * Moonbeam 0x05498574BD0Fa99eeCB01e1241661E7eE58F8a85 Verified
 * Manta 0x2dB08783F13c4225A1963b2437f0D459a5BCB4D8 Verified
 * Boba 0x2dB08783F13c4225A1963b2437f0D459a5BCB4D8 Verified
 * Blast 0xBdCF0bb40eb8642f907133bDB5Fcc681D81f0651 Verified
 * Rootstock 0x2dB08783F13c4225A1963b2437f0D459a5BCB4D8 Verified
 * PolygonZkEvm 0x2dB08783F13c4225A1963b2437f0D459a5BCB4D8 Verified too broke :(
 * Scroll 0xE565E118e75304dD3cF83dff409c90034b7EA18a Verified
 */
